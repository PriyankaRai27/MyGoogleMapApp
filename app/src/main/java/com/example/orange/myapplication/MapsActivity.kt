...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
                ...
                .enqueue(object : Callback<PlacesModal> {
                    ...
                    override fun onResponse(call: Call<PlacesModal>?, response: Response<PlacesModal>?) {
                        ...
                        currentPlace = response!!.body()
                         ...
                         var mSize :Int=response.body()!!.results!!.size
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.setOnMarkerClickListener{  marker->
                    ...
                    Common.currentResults = currentPlace!!.results!![Integer.parseInt(marker.snippet)];
//start ne activity
                    startActivity(Intent(this,DetailOfPlaces::class.java))
            true
